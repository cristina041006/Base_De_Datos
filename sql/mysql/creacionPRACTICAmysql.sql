...
(
	...
	NOMBRE VARCHAR(20),
	CIUDAD VARCHAR(20),
	CONSTRAINT PK_COM PRIMARY KEY (CIF)
);
...
(
	...
	CONSTRAINT FK1_DES FOREIGN KEY (ID_FAB) REFERENCES FABRICANTE(ID_FAB),
	CONSTRAINT FK2_DES FOREIGN KEY (CODIGO) REFERENCES PROGRAMA(CODIGO)
);
...
(
	...
	CONSTRAINT FK1_DIS FOREIGN KEY (CIF) REFERENCES COMERCIO(CIF),
	CONSTRAINT FK2_DIS FOREIGN KEY (CODIGO) REFERENCES PROGRAMA(CODIGO)
);
...
(
	...
	CODIGO INTEGER(10),
	MEDIO VARCHAR(30),
	CONSTRAINT PK_REGI PRIMARY KEY (CIF, DNI, CODIGO),
	CONSTRAINT FK1_REGI FOREIGN KEY (CIF) REFERENCES COMERCIO(CIF),
	CONSTRAINT FK2_REGI FOREIGN KEY (DNI) REFERENCES CLIENTE(DNI),
	CONSTRAINT FK3_REGI FOREIGN KEY (CODIGO) REFERENCES PROGRAMA(CODIGO)
);
